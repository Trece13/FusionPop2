<%@ Page Title="" Language="C#" MasterPageFile="~/MDMasterPage.Master" AutoEventWireup="true" CodeBehind="whMenuI.aspx.cs" Inherits="whusap.WebPages.Login.whMenuI"  Theme="Cuadriculas" EnableViewState="true" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Encabezado" runat="server">
    ...
    <style type="text/css">
        ...
        .btx{background-color:white;border:0px solid white;color:gray;}
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <table id="tblTitleMain"><tr><td><h1 id="LblTitleMainMenu" class="bd-title" style="font-family: 'Segoe UI Light';text-align: left;">Web portal main menu</h1></td><td><img alt=""  
                                 src="<%= String.Concat(ConfigurationManager.AppSettings["UrlBase"], "/images/Grupo-Phoenix-1.png") %>" 
                                 align="middle" width="70px"/></td></tr></table>
    ...
    <div id="Reportissues">
    <button type="button" class="btn btn-danger btn-lg">Report Issues</button>
    </div>
    </div>
</asp:Content>
