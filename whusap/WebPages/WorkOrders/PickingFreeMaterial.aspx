<%@ Page Title="" Language="C#" MasterPageFile="~/MDMasterPage.Master" AutoEventWireup="true" CodeBehind="PickingFreeMaterial.aspx.cs" Inherits="whusap.WebPages.WorkOrders.PickingFreeMaterial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <script>
        ...
        var EventoAjax = function (Method, Data, MethodSuccess) {
            $.ajax({
                type: "POST",
                url: "PickingFreeMaterial.aspx/" + Method.trim(),
                data: Data,
        ...
        function ShowCurrentOptionsItem() {
            ...
            var bodyRows = ""
                ...
                type: "POST",
                url: "PickingFreeMaterial.aspx/ShowCurrentOptionsItem",
                data: "{}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ShowCurrentOptionsWarehouse() {
            ...
            divTableWarehouse.innerHTML = '';
                ...
                type: "POST",
                async: false,
                url: "PickingFreeMaterial.aspx/GetAllsPAlletsPending",
                data: "{}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
            ...
            if (verificarLoadersInactivos()) {
                ...
                //"'CUNI':'" + $('#Contenido_lblQuantityDesc').html() + "', 'LOCA':'" + $('#Contenido_lbllocation').html() + "', 'CWAR':'" + $('#Contenido_lblWarehouse').html() + "', 'CLOT':'" + $('#Contenido_LblLotId').html() + "'"
                 var  AjaxConfirm = $.ajax({
                    type: "POST",
                    url: "PickingFreeMaterial.aspx/Click_confirPKG",
                    data: dataS,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        function IngresarCausales() {
            $.ajax({
                type: "POST",
                url: "PickingFreeMaterial.aspx/Click_confirCausal",
