    ...
    public partial class PickingConsignmentMaterial : System.Web.UI.Page
    {
        ...
        public static EntidadPicking SkipPicking()
        {
            ...
            while (indexCurrent < DtPalletsPick.Rows.Count && NoHallado == true)
            {
                ...
                {
                    List<EntidadPicking> LstPallet22PAID = twhcolDAL.ConsultarPalletPicking22PAID((DtPalletsPick.Rows[indexCurrent + 1 == DtPalletsPick.Rows.Count-1 ? 0 : indexCurrent + 1]["T$PAID"].ToString()), string.Empty, HttpContext.Current.Session["user"].ToString().Trim(), "1", (DtPalletsPick.Rows[indexCurrent + 1 == DtPalletsPick.Rows.Count-1 ? 0 : indexCurrent + 1]["T$CWAR"].ToString()), (DtPalletsPick.Rows[indexCurrent + 1 == DtPalletsPick.Rows.Count-1 ? 0 : indexCurrent + 1]["T$PICK"].ToString()));
                    List<EntidadPicking> LstPallet42PAID = twhcolDAL.ConsultarPalletPicking042PAID((DtPalletsPick.Rows[indexCurrent + 1 == DtPalletsPick.Rows.Count-1 ? 0 : indexCurrent + 1]["T$PAID"].ToString()), string.Empty, HttpContext.Current.Session["user"].ToString().Trim(), "1", (DtPalletsPick.Rows[indexCurrent + 1 == DtPalletsPick.Rows.Count-1 ? 0 : indexCurrent + 1]["T$CWAR"].ToString()), (DtPalletsPick.Rows[indexCurrent + 1 == DtPalletsPick.Rows.Count-1 ? 0 : indexCurrent + 1]["T$PICK"].ToString()));
                    List<EntidadPicking> LstPallet131PAID = twhcolDAL.ConsultarPalletPicking131PAID((DtPalletsPick.Rows[indexCurrent + 1 == DtPalletsPick.Rows.Count-1 ? 0 : indexCurrent + 1]["T$PAID"].ToString()), MySessionObjPicking.WRH, string.Empty, HttpContext.Current.Session["user"].ToString().Trim(), "1", (DtPalletsPick.Rows[indexCurrent + 1 == DtPalletsPick.Rows.Count-1 ? 0 : indexCurrent + 1]["T$PICK"].ToString()));
