<%@ Page Title="" Language="C#" MasterPageFile="~/MDMasterPage.Master" AutoEventWireup="true"
    CodeBehind="whInvReprintMrbMaterialDisposition.aspx.cs" Inherits="whusap.WebPages.Migration.whInvReprintMrbMaterialDisposition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <script>
        ...
        function sendAjax(WebMethod, Data, FuncitionSucces, asyncMode) {
            var options = {
                type: "POST",
                url: "whInvReprintMrbMaterialDisposition.aspx/" + WebMethod,
                data: Data,
