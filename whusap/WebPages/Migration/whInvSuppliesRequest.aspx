        ...
        <div runat="server" id="divTable" visible="false" style="text-align:center;">
            ...
            <table class='table table-bordered myTable' style='font-size:13px;  text-align:center; font-weight:bold;'>
                <tr style='background-color: lightgray;'>
                    <td>
                        <asp:Label runat="server" ID="lblMachineTable" />
                    </td>
                    <td>
                ...
                <tr style='background-color: white;'>
                    <td>
                        <asp:Label runat="server" ID="lblSequence" />
                    </td>
                    <td>
                    ...
                    <td class="CampoOculto">
                        <asp:Label runat="server" ID="lblMachine1" />
                    </td>
                    <td class="CampoOculto">
                ...
                <tr>
                    ...
                    <td class="CampoOculto">
                        <asp:TextBox ID="txtValueSelect2" ClientIDMode="Static" runat="server" CssClass="TextBoxBig MyText" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>3</td>
                    ...
                    <td class="CampoOculto">
                        <asp:TextBox ID="txtValueSelect3" ClientIDMode="Static" runat="server" CssClass="TextBoxBig MyText" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>4</td>
                    ...
                    <td class="CampoOculto">
                        <asp:TextBox ID="txtValueSelect4" ClientIDMode="Static" runat="server" CssClass="TextBoxBig MyText" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>5</td>
                    ...
                    <td class="CampoOculto">
                        <asp:TextBox ID="txtValueSelect5" ClientIDMode="Static" runat="server" CssClass="TextBoxBig MyText" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
