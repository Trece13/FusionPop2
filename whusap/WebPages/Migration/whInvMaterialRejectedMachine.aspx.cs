...
namespace whusap.WebPages.Migration
{
    public partial class whInvMaterialRejected : System.Web.UI.Page
    {
        #region Propiedades
            ...
            public static string TheItemcantbeempty = mensajes("TheItemcantbeempty");
            public static string TheReasoncantbeempty = mensajes("TheReasoncantbeempty");
            public static string TheRejectTypecantbeempty = mensajes("TheRejectTypecantbeempty");
            public static string TheCantcantbeempty = mensajes("TheCantcantbeempty");
            public static string Thelotcantbeempty = mensajes("Thelotcantbeempty");
