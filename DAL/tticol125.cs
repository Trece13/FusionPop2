...
namespace whusa.DAL
{
    public class tticol125
    {
        ...
        public bool updataPalletStatus022(string paid, string stat)
        {
            method = MethodBase.GetCurrentMethod();

            paramList = new Dictionary<string, object>();
            paramList.Add("p1", paid);
            paramList.Add("p3", stat);// , whcol131 -Delieverd status=9
            //string paid = ParametrosIn.paid.Trim().ToUpperInvariant();
            //int paidStatus = ParametrosIn.conf;
            strSentencia3 = recursos.readStatement(method.ReflectedType.Name, "updataPalletStatus022", ref owner, ref env, tabla, paramList);
        ...
        public bool updataPalletStatus042(string paid, string stat)
        {
            method = MethodBase.GetCurrentMethod();
            ...
            //string paid = ParametrosIn.paid.Trim().ToUpperInvariant();
            //int paidStatus = ParametrosIn.conf;
            strSentencia3 = recursos.readStatement(method.ReflectedType.Name, "updataPalletStatus042", ref owner, ref env, tabla, paramList);
