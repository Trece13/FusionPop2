...
namespace whusa.DAL
{
    public class twhcol122
    {
        ...
        public bool UpdateTtico082StatFreeNew(Ent_tticol082 myObj)
        {
            bool retorno = false;
            method = MethodBase.GetCurrentMethod();
            string metodo2 = "tticol082";
            ...
            paramList.Add("RAND", myObj.RAND);
            string tabla = ".tticol082";
            string name1 = "UpdateTtico082StatFreeNew";
            ...
            {
                strError = "Error finding table [tticol182140]. Try again or contact your administrator \n ";
                log.escribirError(strError + Console.Out.NewLine + ex.Message, stackTrace.GetFrame(1).GetMethod().Name, method.Name, method.ReflectedType.Name);
                Console.WriteLine(ex);
            }
            return retorno;
